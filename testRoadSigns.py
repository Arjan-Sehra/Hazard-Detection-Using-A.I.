...
base_dir = os.path.dirname('testRoadSigns.py')

load_model_dir = os.path.join(base_dir, 'road_sign_cnn_model.h5')
testing_images_dir = os.path.join(base_dir, 'testRoadSigns')
